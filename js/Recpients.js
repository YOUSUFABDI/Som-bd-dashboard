...
function getAllRecpients() {
  $("#recpientsTable tbody").html("");
  $("#recpientsTable thead").html("");
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (status) {
        ...
        $("#recpientsTable tbody").append(tr);
        $("#recpientsTable thead").append(th);
      } else {
...
function handleSearchForm(event) {
  ...
  if (!bloodType) {
    $("#recpientsTable tbody").html(`Nothing Found ‼️`);
  }
